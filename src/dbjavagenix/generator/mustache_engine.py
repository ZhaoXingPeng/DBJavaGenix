...
from ..core.java_identifiers import to_camel_case
...
class TemplateContext:
    ...
    @staticmethod
    def build_entity_context(table: TableInfo, config: GenerationConfig) -> Dict[str, Any]:
    ...
    @staticmethod
    def build_mapper_context(table: TableInfo, config: GenerationConfig) -> Dict[str, Any]:
    ...
    @staticmethod
    def build_dto_context(table: TableInfo, config: GenerationConfig) -> Dict[str, Any]:
    ...
    def _get_entity_imports(table: TableInfo, config: GenerationConfig) -> List[str]:
        ...
        # JPA imports
        if config.use_jpa:
            imports.extend(["javax.persistence.*"])

        # Swagger imports
        if config.use_swagger:
            imports.extend(
                ["io.swagger.annotations.ApiModel", "io.swagger.annotations.ApiModelProperty"]
            )
    ...
    def _get_dto_imports(table: TableInfo, config: GenerationConfig) -> List[str]:
        ...
        # Validation imports
        imports.extend(["javax.validation.constraints.*"])
